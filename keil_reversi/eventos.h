...
enum {T0, T1, BotonPulsado, BP1, BP2, CancelarAlarma, Suspender, JugadaRealizada, JugadaNoValida, MIdle, UART0_ESCRITO, UART0_LEIDO, COMANDO, GSERIE_IMPRIMIR, FIN, CONECTA4, WATCHDOG};
