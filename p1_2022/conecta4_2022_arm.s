...
conecta4_buscar_alineamiento_arm
	...
	cmp r6, #NUM_COLUMNAS 	; salta si r6 <= NUM_COLUMNAS 
	bgt termina 		
	...
	ldr r9, [sp, #36]		 		; r9 = deltaFila = sp + 12
	add r5, r5, r9					; r5 = nueva_fila = fila + delta_fila
	ldr r10, [sp, #40]				; r10 = deltaColumna = sp + 8
	add r6, r6, r10					; r6 = nueva_columna = columna + delta_columna
	;llamamos a la función recursiva
	mov r8, #1						; apilamos en resultado un 1
	STMDB R13!, {r8, r9, r10}		; apilamos los parámetros y el resultado para la siguiente iteración 
	bl conecta4_buscar_alineamiento_arm
	ldr r1, sp 						; leemos resultado (1)
